...
# Custom override of Mastodon's StatusLengthValidator
# 
# DIFFERENCES FROM DISTRIBUTION VERSION:
# - Changed MAX_CHARS constant from 500 to 1000 characters
# 
# Based on: mastodon/app/validators/status_length_validator.rb
