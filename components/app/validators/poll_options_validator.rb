...
# Custom override of Mastodon's PollOptionsValidator
# 
# DIFFERENCES FROM DISTRIBUTION VERSION:
# - Changed MAX_OPTIONS constant from 4 to 8 options
# 
# Based on: mastodon/app/validators/poll_options_validator.rb
