  ...
  return (
    <div className='link-footer'>
      <p>
        ...
        {/* CUSTOM: Added "Learning site" link - not present in distribution version */}
        {/* Use <a> instead of <Link> since /learn is handled by nginx, not React Router */}
        <a href='/learn' target={multiColumn ? '_blank' : undefined}>
          <FormattedMessage id='footer.learning_site' defaultMessage='Learning site' />
        </a>
        <DividingCircle />
